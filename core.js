...
sjcl.codec.utf8String = {
  ...
  toBits: function (str) {
	//console.log('str = '+str+' => '+encodeURIComponent(str)+' => '+unescape(encodeURIComponent(str)));//wr
...
sjcl.hash.sha256.prototype = {
  ...
  update: function (data) {
	...
	//alert('after concat : '+b[0].toString(16));//wr
    if (nl > 9007199254740991){
      throw new sjcl.exception.invalid("Cannot hash more than 2^53 - 1 bits");
    }

    if (typeof Uint32Array !== 'undefined') {
	//alert('sha256 b[0] = '+b[0].toString(16));
	var c = new Uint32Array(b);
	//alert('c[0] = '+c[0].toString(16));//wr
    	var j = 0;
...
sjcl.bn.prime = {
  ...
  // SM2 prime
  p256s: sbp(256, [[0,-1],[64,1],[96,-1],[224,-1]])
};
